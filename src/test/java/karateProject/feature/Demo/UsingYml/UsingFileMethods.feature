...
Feature: Demo using java methods tests
    ...
    Scenario: Create a new project and delete it
        ...
        * def req =  karate.read('classpath:helpers/Models/Demo/Projects/projects_post_200.yml')
        ...
        * def req = karate.read('classpath:helpers/Models/Demo/Projects/projects_delete_204.yml')
	    * def result = call read('classpath:karateProject/feature/Common/Common.feature') req
    ...
    Scenario: Get all active tasks
        ...
        * def req =  karate.read('classpath:helpers/Models/Demo/Tasks/tasks_get_200.yml')
	    * def result = call read('classpath:karateProject/feature/Common/Common.feature') req
